...
import 'package:aa_travel_planner/features/favorites/widgets/remove_favorite_button.dart';
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              RemoveFavoriteButton(favoritesRepository: favoritesRepository, destination: destination),
            ],
          ),
        ),
      ),
